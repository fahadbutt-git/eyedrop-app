...
const SEED_FORMULARY = [
  {
    id: 1,
    brand: "Azarga",
    generic: "Brinzolamide 1% / Timolol 0.5%",
    defaultFreq: 2,
    defaultDrops: 1,
    lu: "310",
  },
  ...
  },
  {
    id: 7,
    brand: "Combigan",
    generic: "Brimonidine 0.2% / Timolol 0.5%",
    defaultFreq: 2,
    defaultDrops: 1,
    lu: "310",
  },
  {
    id: 8,
    brand: "Cosopt",
    generic: "Dorzolamide 2% / Timolol 0.5%",
    defaultFreq: 2,
    defaultDrops: 1,
    lu: "310",
  },
  {
    id: 9,
    brand: "Cosopt-PF",
    generic: "Dorzolamide 2% / Timolol 0.5% PF",
    defaultFreq: 2,
    defaultDrops: 1,
    lu: "310",
  },
  {
    id: 10,
    brand: "DuoTrav",
    generic: "Travaprost 0.004% / Timolol 0.5%",
    defaultFreq: 1,
    defaultDrops: 1,
    lu: "310",
  },
  ...
  },
  {
    id: 15,
    brand: "Simbrinza",
    generic: "Brinzolamide 1% / Brimonidine 0.2%",
    defaultFreq: 2,
    defaultDrops: 1,
    lu: "466",
  },
  ...
  },
  {
    id: 22,
    brand: "Vyzulta",
    generic: "Latanoprostene Bunod 0.024%",
    defaultFreq: 1,
    defaultDrops: 1,
    lu: "172",
  },
  {
    id: 23,
    brand: "Xalacom",
    generic: "Latanoprost 0.005% / Timolol 0.5%",
    defaultFreq: 1,
    defaultDrops: 1,
    lu: "310",
  },
  ...
  },
  {
    id: 26,
    brand: "Pred Forte",
    generic: "Prednisolone Acetate 1%",
    defaultFreq: 4,
    defaultDrops: 1,
    lu: "—",
  },
...
function makeEmptySlots() {
  return Array.from({ length: 5 }, () => ({ ...EMPTY_DROP }));
}
  ...
  return (
    ...
    >
      {Array.from({ length: count }).map((_, i) => (
        <span
          key={i}
          style={{ fontSize: 16, cursor: "default", color: "#4a5568" }}
        >
          ☐
        </span>
      ))}
...
export default function App() {
  ...
  const saveEdit = () => {
    ...
    setFormulary((f) =>
      f.map((m) => (m.id === editingId ? { ...editBuf } : m)),
    );
    setEditingId(null);
    setEditBuf({});
  };
  ...
  const mergedDrops = [];
  allDrops.forEach((d) => {
    const ex = mergedDrops.find(
      (m) => m.brand === d.brand && m.freq === d.freq && m.drops === d.drops,
    );
    if (ex) ex.eye = "Both Eyes (OU)";
    else mergedDrops.push({ ...d });
  });
    ...
    if (type === "freq")
      return (
        <select
          value={editBuf[field]}
          onChange={(e) =>
            setEditBuf((b) => ({ ...b, [field]: Number(e.target.value) }))
          }
          style={{
            width: "100%",
            padding: "5px 8px",
          ...
          {tabs.map((t) => (
            <button
              ...
              style={{
                ...
                color: activeTab === t.id ? "#fff" : "#90cdf4",
                boxShadow:
                  activeTab === t.id
                    ? "0 4px 15px rgba(66,153,225,0.35)"
                    : "none",
              }}
            >
              {t.label}
          ...
          <div>
            ...
            >
              <div className="formulary-toolbar">
                <div>
                  <div
                    style={{ fontSize: 17, fontWeight: 700, color: "#1a365d" }}
                  >
                    Drug Formulary
                  </div>
                  <div style={{ fontSize: 12, color: "#718096", marginTop: 1 }}>
                    {formulary.length} medications · tap any row to edit
                  </div>
                </div>
                <input
                  value={searchQ}
                  onChange={(e) => setSearchQ(e.target.value)}
                  placeholder="🔍  Search brand, generic, or LU code…"
                  style={{
                    flex: 1,
                    minWidth: 160,
                    padding: "9px 14px",
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: addingNew
                      ? "none"
                      : "0 4px 12px rgba(72,187,120,0.35)",
                    whiteSpace: "nowrap",
                  }}
                >
                  + Add Medication
            ...
            >
              <div style={{ overflowX: "auto" }}>
                ...
                >
                  <thead>
                    <tr
                      style={{
                        background: "linear-gradient(135deg,#1a365d,#2a4a8a)",
                      }}
                    >
                      <SortTh
                        col="brand"
                      ...
                      <SortTh
                        col="defaultFreq"
                        style={{ ...thBase, width: 110 }}
                      >
                        Frequency
                      </SortTh>
                      <SortTh
                        col="defaultDrops"
                        style={{ ...thBase, width: 90 }}
                      >
                        # Drops
                      </SortTh>
                      <SortTh col="lu" style={{ ...thBase, width: 90 }}>
                        LU Code
                      </SortTh>
                  ...
                  <tbody>
                    {addingNew && (
                      ...
                      >
                        <td style={{ ...tdBase, paddingLeft: 14 }}>
                          <input
                            value={newMed.brand}
                            onChange={(e) =>
                              setNewMed((m) => ({
                        ...
                        <td style={tdBase}>
                          <input
                            ...
                            placeholder="Generic / concentration"
                            style={{
                              width: "100%",
                              padding: "5px 8px",
                              borderRadius: 6,
                        ...
                        <td style={tdBase}>
                          <select
                            value={newMed.defaultFreq}
                            onChange={(e) =>
                              setNewMed((m) => ({
                                ...m,
                                defaultFreq: Number(e.target.value),
                              }))
                            }
                            style={{
                              width: "100%",
                        ...
                        <td style={tdBase}>
                          <select
                            value={newMed.defaultDrops}
                            onChange={(e) =>
                              setNewMed((m) => ({
                                ...m,
                                defaultDrops: Number(e.target.value),
                              }))
                            }
                            style={{
                              width: "100%",
                        ...
                        <td style={tdBase}>
                          <input
                            value={newMed.lu}
                            onChange={(e) =>
                              setNewMed((m) => ({ ...m, lu: e.target.value }))
                            }
                            placeholder="e.g. 172"
                            style={{
                              width: "100%",
                      ...
                      return (
                        <tr key={med.id} style={{ background: rowBg }}>
                          ...
                          <td style={{ ...tdBase, background: rowBg }}>
                            {isEditing ? (
                              <EditCell field="defaultFreq" type="freq" />
                            ) : (
                              <span
                                style={{
                                  padding: "2px 10px",
                          ...
                          >
                            {isEditing ? (
                              <EditCell field="defaultDrops" type="drops" />
                            ) : (
                              `${med.defaultDrops} drop${med.defaultDrops > 1 ? "s" : ""}`
                            )}
                          </td>
                          <td style={{ ...tdBase, background: rowBg }}>
                            {isEditing ? (
              ...
              >
                ...
                <span style={{ marginLeft: "auto" }}>
                  Changes here auto-populate Drop Selection
                </span>
              </div>
            </div>
          </div>
                        ...
                        <div key={i} className="drop-row">
                          <div
                            style={{
                              ...
                              height: 24,
                              marginTop: 4,
                              background: drop.brand ? color : "#e2e8f0",
                              borderRadius: "50%",
                              display: "flex",
                              alignItems: "center",
                              justifyContent: "center",
                          ...
                          <div>
                            <select
                              value={drop.brand}
                              onChange={(e) =>
                                updateDrop(side, i, "brand", e.target.value)
                              }
                              style={{
                                width: "100%",
                                padding: "7px 10px",
                                borderRadius: 8,
                                border: `1.5px solid ${drop.brand ? color : "#cbd5e0"}`,
                                color: drop.brand ? "#1a202c" : "#a0aec0",
                                background: drop.brand ? light : "#fff",
                                outline: "none",
                                cursor: "pointer",
                              }}
                            >
                              ...
                              <div className="drop-selects">
                                <select
                                  ...
                                  style={{
                                    ...
                                    padding: "6px 8px",
                                    borderRadius: 8,
                                    border: `1.5px solid ${drop.brand ? color : "#e2e8f0"}`,
                                    color: drop.brand ? "#1a202c" : "#a0aec0",
                                    background: drop.brand ? light : "#f7fafc",
                                    outline: "none",
                                  }}
                                >
                                  {FREQ_OPTIONS.map((f) => (
            ...
            {activeRight.length === 0 && activeLeft.length === 0 ? (
              ...
              >
                ...
                <div style={{ fontSize: 13, color: "#718096" }}>
                  Go to Drop Selection to choose medications
                </div>
              </div>
            ) : (
              <div ref={printRef}>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      >
                        {MONTH_NAMES[scheduleMonth]} {scheduleYear}
                      </div>
                    </div>
                    <div style={{ display: "flex", gap: 18 }}>
                      {activeRight.length > 0 && (
                        <div style={{ textAlign: "center" }}>
                          ...
                          <div style={{ fontSize: 13, fontWeight: 700 }}>
                            {activeRight.length} drop
                            {activeRight.length > 1 ? "s" : ""}
                          </div>
                        </div>
                      )}
                      {activeLeft.length > 0 && (
                        <div style={{ textAlign: "center" }}>
                          ...
                          <div style={{ fontSize: 13, fontWeight: 700 }}>
                            {activeLeft.length} drop
                            {activeLeft.length > 1 ? "s" : ""}
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    >
                      <thead>
                        <tr>
                          ...
                          {activeRight.length > 0 && (
                            <th
                              colSpan={activeRight.length}
                              style={{ ...thBase, background: "#1a4a8a" }}
                            >
                              RIGHT EYE (OD)
                            </th>
                          )}
                          {activeLeft.length > 0 && (
                            <th
                              colSpan={activeLeft.length}
                              style={{ ...thBase, background: "#1a5c3a" }}
                            >
                              LEFT EYE (OS)
                            </th>
                          )}
                        ...
                        <tr>
                          <th
                            style={{ ...th2Base, background: "#4a5568" }}
                          ></th>
                          <th
                            style={{ ...th2Base, background: "#4a5568" }}
                          ></th>
                          {activeRight.map((d, i) => (
                            <th
                              key={i}
                              style={{ ...th2Base, background: "#2b6cb0" }}
                            >
                          ...
                          {activeLeft.map((d, i) => (
                            <th
                              key={i}
                              style={{ ...th2Base, background: "#276749" }}
                            >
                              <div style={{ fontWeight: 700, fontSize: 11 }}>
                                {d.brand}
                              </div>
                          ...
                          return (
                            <tr key={dayIdx}>
                              ...
                              {activeRight.map((d, i) => (
                                <td
                                  key={i}
                                  style={{ ...tdBase, background: rowBg }}
                                >
                                  <CheckBoxes count={d.freq} />
                                </td>
                              ))}
                              {activeLeft.map((d, i) => (
                                <td
          ...
          <div className="rx-layout">
            ...
            >
              ...
              >
                ...
                <div style={{ fontSize: 11, color: "#e9d8fd", marginTop: 2 }}>
                  Auto-fills the prescription header
                </div>
              </div>
              <div style={{ padding: "16px 18px" }}>
                {[
                ...
                <div style={{ marginBottom: 12 }}>
                  ...
                  <div style={{ display: "flex", gap: 7, flexWrap: "wrap" }}>
                    {[0, 1, 2, 3, 4, 5].map((n) => (
                      <button
                        key={n}
                        onClick={() => setRxRefills(n)}
                        style={{
                          width: 34,
                          height: 34,
                          borderRadius: "50%",
                          border: `2px solid ${rxRefills === n ? "#6b46c1" : "#cbd5e0"}`,
                          background: rxRefills === n ? "#6b46c1" : "#fff",
                          color: rxRefills === n ? "#fff" : "#4a5568",
                          fontWeight: 700,
                          cursor: "pointer",
                        }}
                      >
                  ...
                  <div style={{ fontSize: 11, color: "#718096", marginTop: 5 }}>
                    {rxRefills === 0
                      ? "No refills"
                      : `${rxRefills} refill${rxRefills > 1 ? "s" : ""} authorized`}
                  </div>
                </div>
                <div>
                  <div
                  ...
                  <textarea
                    ...
                    placeholder="e.g. Apply gentle pressure to inner corner of eye for 1 minute…"
                    rows={3}
                    style={{
                      width: "100%",
                      padding: "8px 12px",
            ...
            <div>
              ...
              >
                Preview — print to give to patient
              </div>
              <div ref={rxPrintRef}>
                <div
                  className="rx-paper"
                ...
                >
                  <div
                    style={{
                      ...
                      paddingBottom: 12,
                      borderBottom: "2.5px solid #1a365d",
                      marginBottom: 14,
                      flexWrap: "wrap",
                      gap: 10,
                    }}
                  ...
                  {mergedDrops.length === 0 ? (
                    ...
                    >
                      No medications selected — go to Drop Selection tab.
                    </div>
                  ) : (
                    mergedDrops.map((d, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            Instill <strong>{d.drops}</strong> drop
                            {d.drops > 1 ? "s" : ""} —{" "}
                            <strong>
                              {FREQ_LABEL[d.freq] || `${d.freq}x/day`}
                            </strong>
                          </div>
                          <div
                            style={{
                          ...
                          {[1, 2, 3, 4, 5].map((n) => (
                            <span
                              ...
                              style={{
                                ...
                                fontSize: 10,
                                fontWeight: 700,
                                background: rxRefills >= n ? "#1a365d" : "#fff",
                                color: rxRefills >= n ? "#fff" : "#333",
                              }}
                            >
                              {n}
                            </span>
